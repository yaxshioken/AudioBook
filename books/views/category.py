...
from books.serializers.category import CategorySerializer, ChoiceCategorySerializer
...
class ChoiceCategoryAPIView(APIView):
    ...
    def post(self, request):
        ...
        if not categories.exists():
            return Response({"error": "Kiritilgan ID bo'yicha kategoriya topilmadi"}, status=404)
